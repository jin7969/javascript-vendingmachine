...
/* harmony import */ var _utils_api_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/api.js */ "./src/js/utils/api.js");
/* harmony import */ var _utils_dom_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/dom.js */ "./src/js/utils/dom.js");
/* harmony import */ var _utils_validation_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/validation.js */ "./src/js/utils/validation.js");
...
(0,_utils_dom_js__WEBPACK_IMPORTED_MODULE_4__.$)('#profile-form').addEventListener('submit', /*#__PURE__*/function () {
  var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(event) {
    var email, name, password, passwordConfirm, user, userInfo;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            event.preventDefault();
            email = (0,_utils_dom_js__WEBPACK_IMPORTED_MODULE_4__.$)('#profile-email').value;
            name = (0,_utils_dom_js__WEBPACK_IMPORTED_MODULE_4__.$)('#profile-name').value;
            password = (0,_utils_dom_js__WEBPACK_IMPORTED_MODULE_4__.$)('#profile-password').value;
            passwordConfirm = (0,_utils_dom_js__WEBPACK_IMPORTED_MODULE_4__.$)('#profile-password-confirm').value;
            user = {
              email: email,
              name: name,
              password: password
            ...
            _context.prev = 7;
            (0,_utils_validation_js__WEBPACK_IMPORTED_MODULE_5__.validPassword)(password, passwordConfirm);
            _context.next = 11;
            return (0,_utils_api_js__WEBPACK_IMPORTED_MODULE_3__.requestUpdate)(user, userInfo.id);
