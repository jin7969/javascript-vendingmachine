...
(0,_utils_dom_js__WEBPACK_IMPORTED_MODULE_4__.$)('#login-form').addEventListener('submit', /*#__PURE__*/function () {
  var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(event) {
    var email, password, response, accessToken, user;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            event.preventDefault();
            email = (0,_utils_dom_js__WEBPACK_IMPORTED_MODULE_4__.$)('#login-email').value;
            password = (0,_utils_dom_js__WEBPACK_IMPORTED_MODULE_4__.$)('#login-password').value;
            _context.next = 5;
            return (0,_utils_api_js__WEBPACK_IMPORTED_MODULE_3__.requestLogin)(email, password);
