...
/* harmony import */ var _utils_api_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/api.js */ "./src/js/utils/api.js");
...
(0,_utils_dom_js__WEBPACK_IMPORTED_MODULE_3__.$)('#sign-up-form').addEventListener('submit', /*#__PURE__*/function () {
  var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(event) {
    var email, name, password, passwordConfirm, user;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            event.preventDefault();
            email = (0,_utils_dom_js__WEBPACK_IMPORTED_MODULE_3__.$)('#sign-up-email').value;
            name = (0,_utils_dom_js__WEBPACK_IMPORTED_MODULE_3__.$)('#sign-up-name').value;
            password = (0,_utils_dom_js__WEBPACK_IMPORTED_MODULE_3__.$)('#sign-up-password').value;
            passwordConfirm = (0,_utils_dom_js__WEBPACK_IMPORTED_MODULE_3__.$)('#sign-up-password-confirm').value;
            user = {
              email: email,
              name: name,
              password: password
            ...
            _context.next = 10;
            return (0,_utils_api_js__WEBPACK_IMPORTED_MODULE_4__.requestRegister)(user);
